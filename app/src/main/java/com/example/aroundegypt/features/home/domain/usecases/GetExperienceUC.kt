...
class GetExperienceUC(private val repository: IExperiencesRepository) {
    operator fun invoke(id: String) = flow {
        emit(Resource.Loading())
        val experiences = repository.getExperienceById(id)
        ...
        val exception =
            when (throwable) {
                ...
                else -> AroundEgyptException.UnknownException("Unknown error in GetExperienceUC: $throwable")
            }
