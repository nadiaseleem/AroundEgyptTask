...
class ExperiencesRemoteDS(private val networkProvider: IRestApiNetworkProvider) :
    ...
    override suspend fun getRecommendedExperiences(): List<ExperienceDto> {
    ...
    override suspend fun getMostRecentExperiences(): List<ExperienceDto> {
        return networkProvider.get<ExperiencesResponseDto>(
            pathUrl = "v2/experiences",
            responseType = ExperiencesResponseDto::class.java
        ).experiences ?: listOf()
    ...
    override suspend fun searchExperiences(query: String): List<ExperienceDto> {
        return networkProvider.get<ExperiencesResponseDto>(
            pathUrl = "v2/experiences",
